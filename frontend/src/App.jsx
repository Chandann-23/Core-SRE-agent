...
const calculateAccurateMttr = (startTime, endTime) => {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col" style={{background: '#000000', fontFamily: '"Consolas", "Monaco", "Courier New", monospace'}}>
          ...
          <header className="relative flex h-14 items-center justify-between bg-black backdrop-blur-3xl px-5">
            <div className="flex items-center gap-3">
              <button
                type="button"
                onClick={() => setIsSidebarOpen((prev) => !prev)}
                className="inline-flex items-center justify-center rounded-md border border-purple-400/30 bg-purple-950/40 px-2.5 py-1.5 text-xs text-purple-300 hover:bg-purple-950/60" style={{fontFamily: '"Consolas", "Monaco", "Courier New", monospace'}}
            ...
            <div className="relative flex min-h-0 flex-col border border-purple-400/30 bg-purple-950/40 backdrop-blur-3xl rounded-lg lg:border-b-0">
              <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500 ml-2" style={{fontFamily: '"Consolas", "Monaco", "Courier New", monospace'}}>Editor</span>
                </div>
              ...
              <div className="code-panel-reset h-full flex-1 overflow-y-auto overflow-x-hidden">
                {showDiff ? (
                  <div className="h-full overflow-auto bg-[#050505] p-2" style={{fontFamily: '"Consolas", "Monaco", "Courier New", monospace'}}>
                    {isRepairing ? (
                ...
                {timelineEntries.map((entry, index) =>
                  entry.type === "terminal" ? (
                    <div
                      ...
                      className="flex items-center justify-between rounded border border-purple-500/30 bg-purple-950/40 px-3 py-2 text-xs text-purple-300" style={{fontFamily: '"Consolas", "Monaco", "Courier New", monospace'}}
                    >
